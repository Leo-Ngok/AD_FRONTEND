...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/https://gitlab.secoder.net/untitled/untitled-frontend',
    component: undefined,
    redirect: 'https://gitlab.secoder.net/untitled/untitled-frontend',
    meta: { title: 'GitLab Repository', external: true, icon: Link },
  },
]
